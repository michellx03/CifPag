...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a></a href="/CifPag/Operacao/Consulta">Operacao</a>
				<i class="fa fa-circle"></i></li>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="portlet light bordered">
				...
				<div class="btn-group">
						<a href="/CifPag/Operacao/Cadastro"
						...
						<tbody>
							...
							<%
								EntityManager em = new ConexaoEntityFactory().getEntityManager();
									Query query = (Query) em.createNativeQuery("Select oper_id, oper_operacao from sistema.operacao");
								...
								<td class="hidden-xs">
									<div class="btn-group pull-right">
										...
										<ul class="dropdown-menu pull-right">
											<li><a
												href="/CifPag/Operacao/Editar?id=<%out.print(obj[0]);%>">
													<i class="fa fa-edit"></i> Alterar
											</a></li>
											<li><a
												href="/CifPag/Operacao/Excluir?id=<%out.print(obj[0]);%>">
