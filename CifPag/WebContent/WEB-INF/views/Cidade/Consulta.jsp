...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a></a href="/CifPag/Cidade/Consulta">Cidade</a>
				<i class="fa fa-circle"></i></li>
						...
						<tbody>
							...
							<%
								EntityManager em = new ConexaoEntityFactory().getEntityManager();
									Query query = (Query) em.createNativeQuery("Select cida_id, cida_cidade, cida_cep from sistema.cidade");
								...
								<td class="hidden-xs">
									<div class="btn-group pull-right">
										...
										<ul class="dropdown-menu pull-right">
											<li><a
												href="/CifPag/Cidade/Editar?id=<%out.print(obj[0]);%>">
													<i class="fa fa-edit"></i> Alterar
											</a></li>
											<li><a
												href="/CifPag/Cidade/Excluir?id=<%out.print(obj[0]);%>">
