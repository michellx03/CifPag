...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a href="/CifPag/Cidade/Consulta">Cidade Consulta</a>
				<i class="fa fa-circle"></i></li>
	...
	<!-- BEGIN PAGE TITLE-->
	<h1 class="page-title">
		Cadastro de Cidade <small>Campos Obrigatórios (*)</small>
	</h1>
	<!-- END PAGE TITLE-->
	<!-- END PAGE HEADER-->
					...
					<div class="col-md-12">
						...
						<div class="portlet light portlet-fit portlet-form bordered">
							...
							<div class="portlet-body">
								<!-- BEGIN FORM-->
								<form action="/CifPag/Cidade/Salvar"
									id="form_sample_2" method="POST" class="form-horizontal">

									<input style="display: none" name="cidaId" id="id"
										value="${cidade.cidaId}">
									...
									<div class="form-body">
										...
										<div class="form-group  margin-top-20">
											<label class="control-label col-md-3">Cidade <span
												class="required"> * </span>
											</label>
											<div class="col-md-4">
												<div class="input-icon right">
													<i class="fa"></i> <input type="text" class="form-control" id="cidaCidade"
														name="cidaCidade"  value="${cidade.cidaCidade}" />
												</div>
											</div>
										</div>
										<div class="form-group  margin-top-20">
											...
											<div class="col-md-4">
												<div class="input-icon right">
													<i class="fa"></i> <input type="text" id="cidaCep"
														class="form-control" value="${cidade.cidaCep}"
														name="cidaCep" />
												</div>
											</div>
										</div>
