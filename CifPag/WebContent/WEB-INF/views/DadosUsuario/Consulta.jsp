...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a></a href="/CifPag/DadosUsuario/Consulta">Dados Usuario</a>
				<i class="fa fa-circle"></i></li>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="portlet light bordered">
				...
				<div class="btn-group">
						<a href="/CifPag/DadosUsuario/Cadastro"
						...
						<tbody>
							...
							<%
								EntityManager em = new ConexaoEntityFactory().getEntityManager();
									Query query = (Query) em.createNativeQuery("SELECT clie_id, clie_nome, clie_telefone, cida_cidade FROM sistema.dados_usuario INNER JOIN sistema.endereco ON ende_id = clie_endereco INNER JOIN sistema.cidade ON cida_id = ende_cidade");
								...
								<td class="hidden-xs">
									<div class="btn-group pull-right">
										...
										<ul class="dropdown-menu pull-right">
											<li><a
												href="/CifPag/DadosUsuario/Editar?id=<%out.print(obj[0]);%>">
													<i class="fa fa-edit"></i> Alterar
											</a></li>
											<li><a
												href="/CifPag/DadosUsuario/Excluir?id=<%out.print(obj[0]);%>">
