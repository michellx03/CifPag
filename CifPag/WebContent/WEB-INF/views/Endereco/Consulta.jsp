...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a></a href="/CifPag/Endereco/Consulta">Endereco</a>
				<i class="fa fa-circle"></i></li>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="portlet light bordered">
				...
				<div class="btn-group">
						<a href="/CifPag/Endereco/Cadastro"
						...
						<tbody>
							...
							<%
								EntityManager em = new ConexaoEntityFactory().getEntityManager();
									Query query = (Query) em.createNativeQuery("SELECT ende_id, ende_endereco, ende_bairro, cida_cidade FROM sistema.endereco INNER JOIN sistema.cidade ON ende_cidade = cida_id");
								...
								<td class="hidden-xs">
									<div class="btn-group pull-right">
										...
										<ul class="dropdown-menu pull-right">
											<li><a
												href="/CifPag/Endereco/Editar?id=<%out.print(obj[0]);%>">
													<i class="fa fa-edit"></i> Alterar
											</a></li>
											<li><a
												href="/CifPag/Endereco/Excluir?id=<%out.print(obj[0]);%>">
