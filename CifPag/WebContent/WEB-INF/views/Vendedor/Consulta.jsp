...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a></a href="/CifPag/Vendedor/Consulta">Vendedor</a>
				<i class="fa fa-circle"></i></li>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="portlet light bordered">
				...
				<div class="btn-group">
						<a href="/CifPag/Vendedor/Cadastro"
						...
						<tbody>
							...
							<%
								EntityManager em = new ConexaoEntityFactory().getEntityManager();
									Query query = (Query) em.createNativeQuery("Select vend_id, vend_vendedor, vend_telefone from sistema.vendedor");
								...
								<td class="hidden-xs">
									<div class="btn-group pull-right">
										...
										<ul class="dropdown-menu pull-right">
											<li><a
												href="/CifPag/Vendedor/Editar?id=<%out.print(obj[0]);%>">
													<i class="fa fa-edit"></i> Alterar
											</a></li>
											<li><a
												href="/CifPag/Vendedor/Excluir?id=<%out.print(obj[0]);%>">
...
<script src="/CifPag/assets/global/scripts/datatable.js"
	...
	<script>
		$(document).ready(function() {
			...
			$("#vendedor_li_consulta").addClass('active open');
