...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a></a href="/CifPag/Empresa/Consulta">Empresa</a>
				<i class="fa fa-circle"></i></li>
						...
						<tbody>
							...
							<%
								EntityManager em = new ConexaoEntityFactory().getEntityManager();
									Query query = (Query) em.createNativeQuery("Select empr_id, empr_empresa, empr_cnpj, empr_telefone from sistema.empresa");
								...
								<td class="hidden-xs">
									<div class="btn-group pull-right">
										...
										<ul class="dropdown-menu pull-right">
											<li><a
												href="/CifPag/Empresa/Editar?id=<%out.print(obj[0]);%>">
