...
<%@page
	import="br.com.cifensa.daoGenericos.UsuarioDaoImplementacao"%>
<%@page import="br.com.cifensa.daoGenericos.UsuarioDao"%>
<%@page import="br.com.cifensa.entity.Usuario"%>
...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a href="/Cifensa/Usuario/Consulta">Consulta</a>
				<i class="fa fa-circle"></i></li>
					...
					<div class="col-md-12">
						...
						<div class="portlet light portlet-fit portlet-form bordered">
							...
							<div class="portlet-body">
								<!-- BEGIN FORM-->
								<form action="/Cifensa/Usuario/Salvar"
...
<t:master>
	...
	<jsp:attribute name="scripts_js_page_level_plugins">
        ...
        <script
			src="/Cifensa/assets/global/plugins/jquery-validation/js/jquery.validate.min.js"
...
<script
			src="/Cifensa/assets/pages/scripts/form-validation.min.js"
			type="text/javascript"></script>
