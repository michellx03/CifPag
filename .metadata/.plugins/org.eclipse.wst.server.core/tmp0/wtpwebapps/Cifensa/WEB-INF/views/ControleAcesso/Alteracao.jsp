...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a href="/Cifensa/ControleAcesso/Consulta">Consulta</a>
				<i class="fa fa-circle"></i></li>
		...
		<div class="col-md-12">
			...
			<div class="portlet light form-fit bordered">
				...
				<div class="portlet-body form">
					<!-- BEGIN FORM-->
					<form action="/Cifensa/ControleAcesso/Salvar"
...
<t:master>
	...
	<jsp:attribute name="scripts_js_page_level_scripts">
	 ...
	 <script
			src="/Cifensa/assets/pages/scripts/components-bootstrap-switch.min.js"
