...
<%@page import="br.com.cifpag.daoGenericos.TipoPessoaDao"%>
<%@page import="br.com.cifpag.entity.TipoPessoa"%>

<%
TipoPessoaDao tipoPessoaDAO = new TipoPessoaDaoImplementacao();
TipoPessoa tipoPessoa = tipoPessoaDAO.getById(TipoPessoa.class, Integer.parseInt(request.getAttribute("id").toString()));
%>
...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a href="/CifPag/TipoPessoa/Consulta">Tipo Pessoa Consulta</a>
				<i class="fa fa-circle"></i></li>
	...
	<!-- BEGIN PAGE TITLE-->
	<h1 class="page-title">
		Alteração de Tipo de Pessoa <small>Campos Obrigatórios (*)</small>
	</h1>
	<!-- END PAGE TITLE-->
	<!-- END PAGE HEADER-->
					...
					<div class="col-md-12">
						...
						<div class="portlet light portlet-fit portlet-form bordered">
							...
							<div class="portlet-body">
								<!-- BEGIN FORM-->
								<form action="/CifPag/TipoPessoa/Salvar"
									...
									<div class="form-body">
										...
										<div class="form-group  margin-top-20">
											<label class="control-label col-md-3">Tipo Pessoa <span
												class="required"> * </span>
											</label>
											<div class="col-md-4">
												<div class="input-icon right">
													<i class="fa"></i> <input type="text" class="form-control"
														value="<%out.print(tipoPessoa.getTipoTipoPessoa()); %>"
														name="tipoTipoPessoa" />
												</div>
											</div>
										</div>
