...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a></a href="/CifPag/TipoPessoa/Consulta">Tipo de Pessoa</a>
				<i class="fa fa-circle"></i></li>
						...
						<tbody>
							...
							<%
								EntityManager em = new ConexaoEntityFactory().getEntityManager();
									Query query = (Query) em.createNativeQuery("Select tipo_id, tipo_tipo_pessoa from sistema.tipo_pessoa");
								...
								<td class="hidden-xs">
									<div class="btn-group pull-right">
										...
										<ul class="dropdown-menu pull-right">
											<li><a
												href="/CifPag/TipoPessoa/Editar?id=<%out.print(obj[0]);%>">
...
<script src="/CifPag/assets/global/scripts/datatable.js"
	...
	<script>
		$(document).ready(function() {
			...
			$("#tipo_pessoa_li_consulta").addClass('active open');
