...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a href="/CifPag/Vendedor/Consulta">Vendedor Consulta</a>
				<i class="fa fa-circle"></i></li>
	...
	<!-- BEGIN PAGE TITLE-->
	<h1 class="page-title">
		Cadastro de Vendedores <small>Campos Obrigatórios (*)</small>
	</h1>
	<!-- END PAGE TITLE-->
	<!-- END PAGE HEADER-->
					...
					<div class="col-md-12">
						...
						<div class="portlet light portlet-fit portlet-form bordered">
							...
							<div class="portlet-body">
								<!-- BEGIN FORM-->
								<form action="/CifPag/Vendedor/Salvar"
									id="form_sample_2" method="POST" class="form-horizontal">

									<input style="display: none" name="vendId" id="id"
										value="${vendedor.vendId}">
									...
									<div class="form-body">
										...
										<div class="form-group  margin-top-20">
											<label class="control-label col-md-3">Vendedor <span
												class="required"> * </span>
											</label>
											<div class="col-md-4">
												<div class="input-icon right">
													<i class="fa"></i> <input type="text" class="form-control" id="vendVendedor"
														name="vendVendedor"  value="${vendedor.vendVendedor}" />
												</div>
											</div>
										</div>
										<div class="form-group  margin-top-20">
											...
											<div class="col-md-4">
												<div class="input-icon right">
													<i class="fa"></i> <input type="text" id="vendTelefone"
														class="form-control" value="${vendedor.vendTelefone}"
														name="vendTelefone" />
												</div>
											</div>
										</div>
