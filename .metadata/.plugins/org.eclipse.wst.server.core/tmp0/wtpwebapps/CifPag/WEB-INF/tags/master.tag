...
<html lang="en">
    ...
    <head>
       ...
       <jsp:invoke fragment="scripts_css"/>
        ...
        <link href="/CifPag/assets/global/css/components-rounded.min.css" rel="stylesheet" id="style_components" type="text/css">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        <div class="page-wrapper">
            ...
            <div class="page-header navbar navbar-fixed-top">
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo">
                        <a href="index.html">
                            <img src="/CifPag/assets/layouts/layout/img/logo.png" alt="logo" class="logo-default" /> </a>
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="/CifPag/assets/layouts/layout/img/avatar3_small.jpg" />
                            ...
                            <li id="dashboardli" class="nav-item start">
                                ...
                                <ul class="sub-menu">
                                    <li id="dashboard_li_index" class="nav-item start">
                                        <a href="/CifPag/dashboard/index" class="nav-link ">
                            ...
                            <li id="usuarioli" class="nav-item start">
                                ...
                                <ul class="sub-menu">
                                    <li id="usuario_li_consulta" class="nav-item start">
                                        <a href="/CifPag/Usuario/Consulta" class="nav-link ">
                                            <i class="icon-user"></i>
                                            <span class="title">Usuario</span>
                                            <span class="selected"></span>
                                        </a>
                                    ...
                                    <li id="controle_acesso_li_consulta" class="nav-item start">
                                        <a href="/CifPag/ControleAcesso/Consulta" class="nav-link ">
                                            <i class="icon-lock"></i>
        ...
        <!-- BEGIN QUICK NAV -->
         <!-- END QUICK NAV -->
        <!--[if lt IE 9]>
<script src="/CifPag/assets/global/plugins/respond.min.js"></script>
<script src="/CifPag/assets/global/plugins/excanvas.min.js"></script> 
<script src="/CifPag/assets/global/plugins/ie8.fix.min.js"></script> 
<![endif]-->
        <!-- BEGIN CORE PLUGINS -->
        <script src="/CifPag/assets/global/plugins/jquery.min.js" type="text/javascript"></script>
        <script src="/CifPag/assets/global/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
        <script src="/CifPag/assets/global/plugins/js.cookie.min.js" type="text/javascript"></script>
        <script src="/CifPag/assets/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
        <script src="/CifPag/assets/global/plugins/jquery.blockui.min.js" type="text/javascript"></script>
        <script src="/CifPag/assets/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js" type="text/javascript"></script>
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
       <jsp:invoke fragment="scripts_js_page_level_plugins"/>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="/CifPag/assets/global/scripts/app.min.js" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <jsp:invoke fragment="scripts_js_page_level_scripts"/>
        <!-- END PAGE LEVEL SCRIPTS -->
        <!-- BEGIN THEME LAYOUT SCRIPTS -->
        <script src="/CifPag/assets/layouts/layout/scripts/layout.min.js" type="text/javascript"></script>
        <script src="/CifPag/assets/layouts/layout/scripts/demo.min.js" type="text/javascript"></script>
        <script src="/CifPag/assets/layouts/global/scripts/quick-sidebar.min.js" type="text/javascript"></script>
        <script src="/CifPag/assets/layouts/global/scripts/quick-nav.min.js" type="text/javascript"></script>
