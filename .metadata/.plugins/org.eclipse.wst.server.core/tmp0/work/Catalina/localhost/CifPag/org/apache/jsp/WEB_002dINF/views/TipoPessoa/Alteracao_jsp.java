 ...
 * Generated at: 2018-03-05 20:34:16 UTC
...
TipoPessoa tipoPessoa = tipoPessoaDAO.getById(TipoPessoa.class, Integer.parseInt(request.getAttribute("id").toString()));
      ...
      try {
        ...
        // /WEB-INF/views/TipoPessoa/Alteracao.jsp(19,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_c_005fset_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            out.write("\t\t\t<li><a href=\"/CifPag/TipoPessoa/Consulta\">Tipo Pessoa Consulta</a>\n");
            out.write("\t\t\t\t<i class=\"fa fa-circle\"></i></li>\n");
            ...
            out.write("\t\tAlteração de Tipo de Pessoa <small>Campos Obrigatórios (*)</small>\n");
            out.write("\t</h1>\n");
            ...
            out.write("\t\t\t\t\t\t\t\t<form action=\"/CifPag/TipoPessoa/Salvar\"\n");
...
out.print(request.getAttribute("id"));
            out.write("\"\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\tname=\"tipoId\" />\n");
            out.write("\n");
            out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group  margin-top-20\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"control-label col-md-3\">Tipo Pessoa <span\n");
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalue=\"");
out.print(tipoPessoa.getTipoTipoPessoa()); 
            out.write("\"\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"tipoTipoPessoa\" />\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\n");
  ...
  private boolean _jspx_meth_t_005fmaster_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/TipoPessoa/Alteracao.jsp(101,0) null
