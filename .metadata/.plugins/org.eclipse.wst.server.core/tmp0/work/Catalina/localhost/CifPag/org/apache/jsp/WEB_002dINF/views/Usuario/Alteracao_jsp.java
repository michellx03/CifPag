 ...
 * Generated at: 2018-02-15 22:33:23 UTC
...
Usuario usuario = usuarioDAO.getById(Usuario.class, Integer.parseInt(request.getAttribute("id").toString()));
      ...
      try {
        ...
        // /WEB-INF/views/Usuario/Alteracao.jsp(15,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_c_005fset_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            out.write("\t\t\t<li><a href=\"/CifPag/Usuario/Consulta\">Usuario Consulta</a>\n");
            out.write("\t\t\t\t<i class=\"fa fa-circle\"></i></li>\n");
            ...
            out.write("\t\tAlteração de Usuario <small>Campos Obrigatórios (*)</small>\n");
            out.write("\t</h1>\n");
            ...
            out.write("\t\t\t\t\t\t\t\t<form action=\"/CifPag/Usuario/Salvar\"\n");
...
out.print(request.getAttribute("id"));
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"control-label col-md-3\">Usuario <span\n");
...
out.print(usuario.getUsuaUsuario()); 
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-4\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-icon right\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa\"></i> <input type=\"password\" id=\"senha\"\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalue=\"");
out.print(usuario.getUsuaSenha()); 
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group  margin-top-20\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"control-label col-md-3\">Repita a Senha\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"required\"> * </span>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-4\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-icon right\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa\"></i> <input type=\"password\" equalTo=\"#senha\"\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalue=\"");
out.print(usuario.getUsuaSenha()); 
            out.write("\"\n");
  ...
  private boolean _jspx_meth_t_005fmaster_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/Usuario/Alteracao.jsp(125,0) null
