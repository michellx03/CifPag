 ...
 * Generated at: 2018-03-12 14:09:08 UTC
...
public final class Editar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/tags/master.tag", Long.valueOf(1520378786000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        // /WEB-INF/views/DadosUsuario/Editar.jsp(11,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_c_005fset_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            ...
            out.write("\t\t\t<li><a href=\"/CifPag/DadosUsuario/Consulta\">Dados Usuario Consulta</a>\n");
            out.write("\t\t\t\t<i class=\"fa fa-circle\"></i></li>\n");
            ...
            out.write("\t\tCadastro de Dadosd do usuario <small>Campos Obrigatórios (*)</small>\n");
            out.write("\t</h1>\n");
            ...
            out.write("\t\t\t\t\t\t\t\t<form action=\"/CifPag/DadosUsuario/Alterar\"\n");
            out.write("\t\t\t\t\t\t\t\t\tid=\"form_sample_2\" method=\"POST\" class=\"form-horizontal\">\n");
            out.write("\n");
            out.write("\t\t\t\t\t\t\t\t\t<input style=\"display: none\" name=\"clieId\" id=\"id\"\n");
            out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dadosUsuario.clieId}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
            out.write("\">\n");
            out.write("\n");
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"control-label col-md-3\">Nome Completo <span\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"required\"> * </span>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-4\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-icon right\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa\"></i> <input type=\"text\" class=\"form-control\" id=\"clieNome\"\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"clieNome\"  value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dadosUsuario.clieNome}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
            out.write("\" />\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\n");
            out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group  margin-top-20\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"control-label col-md-3\">Data Nascimento <span\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"required\"> * </span>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-4\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-icon right\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa\"></i> <input type=\"date\" class=\"form-control\" id=\"clieDataNascimento\"\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"clieDataNascimento\"  value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dadosUsuario.clieDataNascimento}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
            out.write("\" />\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\n");
            out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group margin-top-20\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"single\" class=\"control-label col-md-3\">Selecione o tipo de pessoa</label>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-4\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-icon right\">\n");
...
out.print(objTipoPessoa[1]);
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\n");
            out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group  margin-top-20\" hidden id=\"clieRg\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"control-label col-md-3\">Rg <span\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"required\"> * </span>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-4\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-icon right\">\n");
            ...
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dadosUsuario.clieRg}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
            out.write("\"\n");
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\n");
            out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group  margin-top-20\" hidden id=\"clieCpf\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"control-label col-md-3\">CPF <span\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"required\"> * </span>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-4\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-icon right\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa\"></i> <input type=\"text\" \n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dadosUsuario.clieCpf}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
            out.write("\"\n");
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\n");
            out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group  margin-top-20\" hidden id=\"clieCnpj\">\n");
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa\"></i> <input type=\"text\" \n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dadosUsuario.clieCnpj}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
            out.write("\"\n");
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\n");
            out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group  margin-top-20\" hidden id=\"clieNomeFantasia\">\n");
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa\"></i> <input type=\"text\" \n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dadosUsuario.clieNomeFantasia}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
            out.write("\"\n");
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\n");
            out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group  margin-top-20\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"control-label col-md-3\">Celular <span\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"required\"> * </span>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-4\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-icon right\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa\"></i> <input type=\"text\" id=\"clieCelular\"\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dadosUsuario.clieCelular}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
            out.write("\"\n");
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-4\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-icon right\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa\"></i> <input type=\"text\" id=\"clieTelefone\"\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dadosUsuario.clieTelefone}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
            out.write("\"\n");
            ...
            out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\n");
            out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group  margin-top-20\" style=\"display: none\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<label class=\"control-label col-md-3\">Endereco <span\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"required\"> * </span>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t</label>\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-4\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-icon right\">\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"fa\"></i> <input type=\"text\" id=\"clieEndereco\"\n");
            out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dadosUsuario.clieEndereco}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
            out.write("\"\n");
...
out.print(objEnderecoAlterar); 
  ...
  private boolean _jspx_meth_t_005fmaster_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/DadosUsuario/Editar.jsp(290,0) null
      ...
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
      ...
      throws java.lang.Throwable
    {
      ...
      out.write("\t\t\ttype=\"text/javascript\"></script>\n");
      out.write("\t\t\t<script src=\"/CifPag/assets/pages/scripts/DadosUsuarioJS.js\" type=\"text/javascript\"></script>");
      return false;
    }
      ...
      throws java.lang.Throwable
    {
      ...
      out.write("\t\t\n");
      out.write("\t\t<script>\n");
      out.write("\t\tvar iniciar = $('#singleAlter').val();\n");
      out.write("\t\tif(iniciar == 1){\n");
      out.write("\t\t\t$(\"#clieCnpj\").hide();\n");
      out.write("\t         $(\"#clieNomeFantasia\").hide();\n");
      out.write("\t         $(\"#clieCpf\").show();\n");
      out.write("\t         $(\"#clieRg\").show();\n");
      out.write("\t\t}if(iniciar == 2){\n");
      out.write("\t\t\t$(\"#clieCnpj\").show();\n");
      out.write("\t         $(\"#clieNomeFantasia\").show();\n");
      out.write("\t         $(\"#clieCpf\").hide();\n");
      out.write("\t         $(\"#clieRg\").hide();\n");
      out.write("\t\t}if(iniciar == \"\"){\n");
      out.write("\t\t\talert(\"NADA\");\n");
      out.write("\t\t}\n");
      out.write("\t\t\n");
      out.write("\t\t\n");
      out.write("\t\t$('#singleAlter').change(function(){\n");
      out.write("\t\t\tvar id = $('#singleAlter').val();\n");
      out.write("\t\t\tif(id == 1){\n");
      out.write("\t\t\t\t$(\"#clieCnpj\").hide();\n");
      out.write("\t\t         $(\"#clieNomeFantasia\").hide();\n");
      out.write("\t\t         $(\"#clieCpf\").show();\n");
      ...
      out.write("\t\t\t$(\"#dados_usuario_acesso_li_consulta\").addClass('active open');\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t\n");
